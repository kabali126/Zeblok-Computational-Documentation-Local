...
<Frame>
  <img src="/images/plans/plan-options.png" alt="New Plan form showing the two tabs Standard Plan and Auto-Scaling Plan" />
</Frame>
...
Once all required fields are filled in, click **Create Plan** to save the plan. The new plan will then appear in the plans list with its name and configured resources.

<Frame>
  <img src="/images/plans/plan-created.png" alt="Plans list showing the newly created plan appearing at the top with its name, GPU, CPU, memory, storage, datacenter, and visibility details" />
</Frame>
